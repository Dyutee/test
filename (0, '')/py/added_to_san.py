...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=san_list"> iSCSI/SRP/FC</a> <span style="color:#000; "> >> </span>Volumes</div>
"""
print """<iframe src='iframe_added_to_san.py' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

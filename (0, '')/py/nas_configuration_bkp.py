...
try:
	...
	if(form.getvalue("submit")):
		...
		create_nas = storage_op.lvcreate(volume_info,getdisk,getfull_size)	
		
		
		if(create_nas == True):
        		print""" <div id = 'id_trace' >"""
                	print " Nas Disk " " <b><font color ='darkred'>"+ getdisk +"</font></b> " "  Successfully created!"
			print "</div>"
			...
			print""" <div id = 'id_trace_err' >"""
                	...
                	print "Duplicate Entry!Please check your Nas configuration data!"
                	print "</div>"
	...
	<b><i><font color ="darkred" style="font-size:18px;" >Nas Disk Configuration</font></i></b> <br/> <br/></td><td><font color ="darkred">Available Size:</font><font color = "green" style = "text-decoration:blink;">"""+free_sizes+"""</font></td></tr></table><br/><br/><br/>"""


	#vg_info = get_pvs()
	vgs_info = storage.get_vgs()
	print """ 
		<form name = 'nas_config' id = 'nas_configs' method = 'POST' action="">
...
<tr>
	...
	<div>
	<button class="button_example" type="submit" name = 'submit'  id = 'id_create_but' value = 'Create' onclick = 'return validate_nas_configuration();'>Create</button></div>

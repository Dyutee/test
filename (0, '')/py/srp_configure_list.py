...
print """
	...
	<div class="insidepage-heading">San >> Srp >><span class="content">Configure Information</span></div>
	<!--tab srt-->
	...
	<div class="view_option"><a href = 'main.py?page=tar_srp'><img title = 'Create Target' src = '../images/new-folder-9.png' /></a><a href="main.py?page=stat_srp"><img src="../images/grid-view.png" height="30px" width="30px" title="Grid View" /></a> <a href="main.py?page=l_srp"><img src="../images/list-view.png" height="30px" width="30px" title="List View" /></a></div>
	  <div class="inputwrap">

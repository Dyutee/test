...
try:
	...
	if(form.getvalue("submit")):
		...
		create_vtl = storage_op.lvcreate(volume_info,getdisk,getfull_size,type1='VTL')	
		#print create_vtl
		...
		if(create_vtl == True):
        		print""" <div id = 'id_trace' >"""
                	print " Vtl Disk " " <b><font color ='darkred'>"+ getdisk +"</font></b> " "  Successfully created!"
			print "</div>"
			logstatus = common_methods.sendtologs('Success', 'Successfully Created the '+getdisk+' Vtl Disk', 'vtl_configuration.py', str(create_vtl));
		else:
			print""" <div id = 'id_trace_err' >"""

                	print "Please Enter a Valid Vtl configuration data!"
                	print "</div>"
			logstatus = common_methods.sendtologs('Error', 'Error Occurred while Creating the '+getdisk+'Vtl Disk', 'vtl_configuration.py', str(create_vtl));
	...
	<body onload = 'document.nas_config.action_but.disabled = "true";'>
       	<table width = '100%' style = 'font-weight: bold;' border = "0" cellspacing = "0" cellpadding = "0" >
	<tr>
	<td width = "296" class = "table_heading" height = "35px" valign = "middle">
	<b><i><font color ="darkred" style="font-size:18px;" >Vtl Disk Configuration</font></i></b> <br/> <br/></td><td><font color ="darkred">Available Size:</font><font color = "green" style = "text-decoration:blink;">"""+free_sizes+"""</font></td></tr></table><br/><br/><br/>"""


	#vg_info = get_pvs()
	vgs_info = storage.get_vgs()
	print """ 
		<form name = 'vtl_config' id = 'vtl_configs' method = 'POST' action="">
...
<tr>
	...
	<!--<div style="margin-left: 54%;" ><span id="button-one"><button type = 'submit' name="submit" id="id_create_but" value="Create" onclick ="return validate_vtl_configuration();" style = 'width:62px; background-color:#E8E8E8; border:none; float: right;font-size: 86%; ' title="Create"><a style="font-size:100%;">Create</a></button></span></div>-->
	<div>
	<button class="button_example" type="submit" name = 'submit'  id = 'id_create_but' value = 'Create' onclick = 'return validate_vtl_configuration();'>Create</button></div>

...
try:
	...
	<div id="tabs-1">
		...
		<iframe style = 'border: 1px solid;' onload = '' src = 'show_dir1.py?share_name=""" + get_share + """&path=""" + sharepath + """&s=s'></iframe>
		  ...
		  <tr>
		  <td style="color:#585858; font-weight:600;">Log Path:</td>
	...
	<form name= "user_acl" method = "post" action='main.py?page=acl&"""+querystring+"""#subtabs-2'>
	 <table style="width:100%; margin:20px 0 0 0; ">
		 <tr>
		  <td style="color:#585858; font-weight:600;"><b>Log Path</b>:</td>
			<!--access_control_form.selected_file-->
		  <td colspan = '4'>"""
	if(set_path !=''):
	...
	print"""</td>
		...
		<tr>
			<td>Choose a domain: <select name = 'domainslist'>"""
	...
	print """ 	<td>
		<button class="button_example" type="submit" name = 'set' id = "set_id" value = 'Acl' onclick = 'return vlidate_set_acl();'>Set</button></td>
	...
	<table style="width:84%;margin:20px 0 0 0;">
		<tr>
		<td style="color:#585858; font-weight:600;">Log Path:"""
	if(perm_path !=''):
		print """ 
		<input type="text" name = "selected_file" readonly value = '""" + perm_path + """' style = 'width:70%;'>"""
	else:
		print"""
		<input type="text" name = "selected_file" readonly value = '""" + sharepath + """' style = 'width:70%;'></td>
		</tr>
		<tr>
	...
	if(grant_user == None):
		...
		for users_list in lis_info:
			...
			print"""<td style="float:right;margin-right:-36%;margin-top:-3%;"><button type="image" value = "reset" name='"""+users_list+"""reset_single' style="background: #fff; border: 0px;cursor:pointer;" ><img src="../images/reset_acl_img2.png"></button></td> """

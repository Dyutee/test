...
try:
	...
	if(form.getvalue("submit")):
		...
		if(create_vtl == True):
        		print""" <div id = 'id_trace_small' >"""
                	print " Vtl Disk "+ getdisk +" Successfully created!"
			print "</div><br/>"
	...
	vgs_info = storage.get_vgs()
	print """ 
	<form name = 'vtl_config' method = 'POST' action = ''>

<table width="90%" style="margin:20px 0 0 20px; text-align:center; border:#D1D1D1 1px solid;"">
<tr>
<td style=" background-color:#D1D1D1; padding:5px;">Create VTL Disk</td>
</tr>
</table>
...
<tr>
<td>
<button class="buttonClass" style="float:right; margin:0 30px 20px 0; font-size:12px;" type="submit" name = 'submit'  id = 'submit' value = 'submit'  onclick = 'return validate_vtl_configuration();'>Create</button>
</td>
</tr>

...
try:
	...
	if(form.getvalue("submit")):
		...
		update_size = update_size.replace('GB', '')
...
<td width = "172" class = "table_heading" height = "35px" valign = "middle">
                        <b><i><font color ="darkred" style="font-size:18px;" >Update Nas Disk Size</font></i></td><td><b><i><font color ="#7F0101" style= "margin-left:29%;">Available Size:</font></i></b>&nbsp&nbsp<b><font color ="green" style= "text-decoration:blink;">"""+availables_size+"""</font></b> <br/><br/> </td>
	...
	<div style="margin-top:-33%;margin-left:19%;" >
					<table width="120" cellspacing="0" cellpadding="0" border="0" style="margin-left: 10%;">
...
<br/><br/><br/>
	...
	<div>
	 <button class="button_example" type="submit" name = 'submit' id ='id_create_but' value = 'Update' onclick = 'return validate_increase_size();'>Update</button></div>
	...
	disp_except.display_exception(e);
        ...
        #fh.write("<BR>");
        #fh.write('<BR><input type = "button" value = "Back" onclick = "location.href = \'/fs4/py/setup_diskmgr_add_disk.py\'">');

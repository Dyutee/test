...
try:
	...
	from scan_remount import mail_val
	...
	if(form.getvalue("send_mail")):
		...
		send_mail_val = send_mail.send_mail(get_message)
		...
		if(set_smtp_status == True):
                	...
                	print "Mail settings configured successfully!"
                	print "</div>"
	...
	if(form.getvalue("mail_values")):
		...
		if(mail_val_func == True):
                        print"""<div id = 'id_trace'>"""
                        print "Previous mail settings retrieved successfully!"
                        print "</div>"
                        #print "<script>location.href = 'main.py?page=mail#tabs-1';</script>"
                else:
                        print"""<div id = 'id_trace_err'>"""
	...
	if(check_ha == True):
		print"""
	</span></a><p class = "gap_text">Mail Configuration ("""+show_tn+""")</p>
		...
		print """</span></a><p class = "gap_text">Mail Configuration</p></div>"""
	print"""
...
<td valign="top">"""
	if(get_port !=''):
		print"""<input  type="text" class = 'textbox' name="port_name" onkeypress="return isNumberKey(event)" value = '"""+get_port+"""' maxlength="80" size="25" style="width: 218px;">"""
	else:
		print"""<input  type="text" class = 'textbox' name="port_name" onkeypress="return isNumberKey(event)" value = "587" maxlength="80" size="25" style="width: 218px;">"""
	print"""</td>
...
<tr>
 ...
 <td valign="top">
  <input type="text" name="to_mail" class = 'textbox' maxlength="100" size="25" value = '"""+str(get_to)+"""' style="width: 218px;">
 </td>

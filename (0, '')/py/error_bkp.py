#!/usr/bin/python
import cgitb, common_methods, commands, traceback, os, header
...
if (session_user != ''):
	try:
		...
		if (len(array) > 0):
			print """<div style = 'margin-right: 30%; margin-left: 30%; margin-top: 5%; border: 1px solid #BDBDBD; height: 50%; width: 60%; text-align: justify;'>"""
		...
		print """<input type = "button" value = "Send Bug Report" onclick = "location.href = 'mailto:raja@netwebindia.com?subject=BugReport&body=%s'">""" % fh1.read().strip();

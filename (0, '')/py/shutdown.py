...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=sr">SYSTEM</a> <span style="color:#000; "> >> </span> Shutdown</div>
"""
print """<iframe src='iframe_shutdown.py?querystring="""+querystring+"""' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

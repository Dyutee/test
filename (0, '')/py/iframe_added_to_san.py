...
try:
	...
	<!-- ############## Fancybox CSS and JAVASCRIPT End ############## -->
		...
		<div style="margin:0 0 0px 0;" class="topinputwrap-heading"><a class="demo" href ="#"><img src ="../images/help_icon1.png" style="width:13px;"><span class="tooltip" >
                 <table border="0">
        <tr>
        <td class="text_css">This page displays information related to the disks added to SAN.</td>
        </tr>
        </table>"""

	if(check_ha == True):
		print """</span></a> Disks added to SAN ("""+show_tn+""")
                <span style="float:right; margin:5px 0px 0 0;"><a onclick="return onclick_loader();" class="resource_links" href="https://"""+other_node_ip+"""/fs4/py/iframe_added_to_san.py">"""+show_on+"""</a></span>"""
	else:
		print""" </span></a><p style ="margin:-19px 0 0 30px;">Disks added to SAN</p>"""

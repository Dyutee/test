...
try:
	...
	print """ 	<td>
		<div class="buttonWrapper">
		<button class="buttonClass" type="submit" name = 'set' id = "set_id" value = 'Acl' onclick = 'return validate_set_acl();'>Set</button></div></td>
	...
	print"""
		...
		<button class="buttonClass" type="submit" id = 'id_butt' name = 'set_acl' value = 'acl'>Set Acl</button></div>
	...
	print"""></th>
		...
		<div class="buttonWrapper">
		<button class="buttonClass" type = 'button'  name="change_perm_but" onclick="popup('proppopUpDiv7')" value="change_perm_but" >Apply</button></div></div>
...
<br/>
	...
	<div class="buttonWrapper">
        <button class="buttonClass" type="button" name = 'reset_ownership'  id = 'reset_ownership' onclick="popup('proppopUpDiv8')" value = 'ResetOwner'  style="float:right; margin:20px 10px 10px 0;" >Reset</button></div>
<div class="buttonWrapper">	
<button class="buttonClass" type="button" name = 're_assign_ownership'  id = 're_assign_ownership' onclick="popup('proppopUpDiv9')" value = 'Apply'  style="float:right; margin:20px 10px 10px 0;" >Set</button></div>
</div>
	...
	print"""<div style="float:right;margin-top:-6%;">
		<div class="buttonWrapper">
		<button class="buttonClass" type="button" name = 'acl_user_del' onclick="popup('proppopUpDiv10')" value = 'info'>Re-assign</button></div></div>"""
	#else:
	...
	print"""<div style="float:right;margin-top:-6%;">
		<div class="buttonWrapper">
		<button class="buttonClass" type="button" name = 'reset_acl' onclick="popup('proppopUpDiv11')" value = 'Remove' >Remove</button></div></div>"""
	#else:

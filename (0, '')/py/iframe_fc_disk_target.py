...
#print list_fc_target
#--------------------Display Fc Target List---------------------
...
iscsi_status = ''
#---------------------End---------------------------------------
#-------------------This Function to checked used Disk----------------------------
...
if(form.getvalue('assign_disk_nm')):
	...
	print "<script>location.href = 'iframe_fc_disk_target.py?target="+target_name+"#tabs-1';</script>"
...
if(form.getvalue('delete_target_name')):
	...
	print "<script>location.href = 'iframe_fc_disk_target.py?target="+target_name+"#tabs-2';</script>"
...
if (check_fc !=[]):
	...
	if (list_fc_target != []):
		for assign_disk in list_fc_target:
			#print x
	...
	if (list_fc_target != []):
		for delete_assign_disk in list_fc_target:
			#print x

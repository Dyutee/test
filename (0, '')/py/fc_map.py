...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=sr">TOOLS</a> <span style="color:#000; "> >> </span> FC Map Settings </div>
"""
print """<iframe src='iframe_fc_map.py' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

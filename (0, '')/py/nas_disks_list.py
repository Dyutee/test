...
<a class="various" data-fancybox-type="iframe" style="color:#666666;text-decoration:none;" href="nas_configuration.py?volume="""+x["vg_name"]+"""&free_size="""+free_size+"""">"""+x["vg_name"]+"""</a></td>
		...
		<span style="margin-left: -32%;"><font color = '#EC1F27' size = '5'>*</font> - <I style="color:#666666;">Disk is shared</I></span>
						...
						<div style="margin-left: -6.5%; margin-top: -10%;">
                                                <table style =" border:#BDBDBD 1px solid;" cellspacing ="1" align = 'center'>
...
<input name='free_disk_val"""+str(f)+"""' type='hidden' value='"""+str(size_for_graph)+"""' />
	...
	<!--<script type="text/javascript">
	var ro = document.disk_to_delete.free_vg_val.value;
	var test1 = document.disk_to_delete.disk_size_val.value;
	var test = document.disk_form.free_vg_val1.value;
	alert(test)
	var disk_used_size = document.getElementsByName('disk_size_val')[0].value;
	var disk_used_size1 = document.getElementsByName('disk_size_val')[1].value;
	var disk_used_size2 = document.getElementsByName('disk_size_val')[2].value;
	var str_var = document.disk_to_delete.str_var.value;
	var value_of_f = document.disk_to_delete.value_of_f.value;
	str_to_int = parseInt(value_of_f)
	f_value = str_to_int-1
                        $(function ()  
                                {
   var dataSource = [
    { volume: 1, area:parseInt(test) },
    { volume: 2, area:disk_used_size },
    { volume: 3, area:disk_used_size1 },
    { volume: 4, area:disk_used_size2 },
];

...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=report">MONITORING</a> <span style="color:#000; "> >> </span>Clear Data</div>
"""
print """<iframe src='iframe_clear_data.py' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

...
#-------------------------------
for check_used  in nas_info["lvs"]:
	chk_disk =  check_used['lv_name']
	print chk_disk
#-----------------End--------------------
import left_nav
print
...
if(free_d!=[]):
	...
	<td width = "311" class = "table_heading" height = "35px" valign = "middle" bgcolor = "#f5f5f5">
	Disk
	</td>
	<td width = "311" class = "table_heading" height = "35px" valign = "middle" bgcolor = "#f5f5f5">
	Size
 ...
 <button class="button_example" type="submit" name = 'submit_create_vol' value = 'Create Volume' onclick = "return validate_create_vol_form();" >Create Volume</button></div>
	...
	print "<div style='font-size:14px; font-weight:bold;'>No free disks available! </div>"
...
if(vg_info["pvs"]!=[{}]):
	...
	<td width = '15%' class = "table_heading" height = "35px" valign = "middle">
	Volume
	</td>
	<td class = "table_heading" height = "35px" valign = "middle">
	Disk(s) In Use
	...
	for y in nas_info["lvs"]:
		...
		if(y['lv_name']!= ''):
			print"""<input type = 'checkbox' value = '"""+y["vg_name"]+"""' name = 'used_volumes_array[]' disabled id = 'id_used_volumes' >"""

		else:
			print"""<input type = 'checkbox' value = '"""+y["vg_name"]+"""' name = 'used_volumes_array[]' id = 'id_used_volumes' >"""
		print"""</td>
		<td class = "table_content" height = "35px" valign = "middle">"""
		...
		if(nas_info["lvs"]!=[{}]):
			...
			for z in nas_info["lvs"]:
				if(z["vg_name"]==x["vg_name"]):
					...
					print """<span style = "color:#8A2908; cursor:pointer; margin:0; font-weight:bold;" class="btn btnPluginDownload lpTooltip lpRight" data-tooltip-text="""+str(print_protocols)+""">"""+z["lv_name"]+"""</span> ["""+z["size"].replace("g", "GB")+"""]<br/>"""
...
<div style="float:right;margin-top:-3%;">
	...
	print "<div style='padding:15px 0 15px 250px; font-size:14px; font-weight:bold;'>No disks available! </div>"

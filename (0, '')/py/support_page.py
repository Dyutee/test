...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=support">Help</a> <span style="color:#000; "> >> </span> Support Information </div>
"""
print """<iframe src='support_nw.py' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

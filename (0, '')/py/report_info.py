...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=report">MONITORING</a> <span style="color:#000; "> >> </span> Report Information</div>
"""
print """<iframe src='support_nw1.py' style="width:825px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

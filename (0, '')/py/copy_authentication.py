...
<div id="iframe_flow_control" class="iframe-insidepage-heading"><a class="iframe_bc" href="main.py?page=sys">SYSTEM</a> <span style="color:#000; "> >> </span> Authentication </div>
"""
print """<iframe src='iframe_copy_authentication.py' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
print """

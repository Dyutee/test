...
<div id="iframe_flow_control" class="insidepage-heading" style="margin-top: 42px;"><a class="demo" href ="#"><img src ="../images/help_icon1.png" style="border:#000 1px solid; margin:-4px 2px;"><span class="tooltip" >
                 <table border="0">
        <tr>
        <td class="text_css">This page lets you modify the ACL settings for the selected share.</td>
        </tr>
        </table></span></a>NAS >> <span><a class="iframe_bc" href="main.py?page="""+red_page+"""">Shares</a></span> >> ACL Settings</div>
"""
#if(share_node_name == "node1"):
if(share_node_name == sys_node_name):
	print """<iframe src='iframe_set_acl_page.py?share_name="""+share_name+"""' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
else:
	print """<iframe src='https://"""+other_node_ip+"""/fs4/py/iframe_set_acl_page.py?share_name="""+share_name+"""' style="width:795px; border:none; min-height: 500px; height:auto !important; height: 500px;" ></iframe>"""
